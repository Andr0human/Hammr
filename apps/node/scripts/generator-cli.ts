// Session 3 standalone demo: runs a scenario through the VU pool, bypassing
// controller/ws.
//
// Usage:
//   tsx apps/node/scripts/generator-cli.ts --scenario <path.json> [--threads <n>]
//
...
function usage(): void {
  console.error('usage: generator-cli --scenario <path.json> [--threads <n>]');
}
